                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h1 className={styles.chatEmptyStateTitle}>Bienvenido al Asistente Virtual UDP con Azure OpenAI</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Pregúntame sobre tus dudas asociadas al proceso de admisión 2024</h2>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Escriba una nueva pregunta (por ejemplo, ¿Quién es el rector de la UDP?)"
                            disabled={isLoading}
